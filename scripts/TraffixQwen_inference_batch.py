...
if __name__ == '__main__':
    ...
    parser.add_argument("--model-path", type=str, default="../saved_weights/traffix-qwen-google_siglip-so400m-patch14-384-Qwen-Qwen2-0.5B-Instruct-mm_language_model-None")
    ...
    parser.add_argument("--output", type=str, default="qwen_test.json")
