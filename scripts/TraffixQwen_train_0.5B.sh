...
ACCELERATE_CPU_AFFINITY=0 torchrun --nproc_per_node=1 --nnodes=1 --node_rank=0 --rdzv_endpoint=0.0.0.0:29531 \
    ...
    --pretrain_mm_mlp_adapter saved_weights/full-llavanext-google_siglip-so400m-patch14-384-Qwen-Qwen2-0.5B-Instruct-mm_mlp_adapter-tumtrafficqa-nov8-none-dec2-1-adapter/checkpoint-8174/mm_projector.bin \
